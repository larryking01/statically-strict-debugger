...
class AdvanceSettings extends Light {
    ...
    getSelectedSettings(componentName) {
        const markupComponent = this.getSelectedComponent(componentName);
        return __classPrivateFieldGet(this, _AdvanceSettings_instances, "m", _AdvanceSettings_markup).call(this, markupComponent);
    }
